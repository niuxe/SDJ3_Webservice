...
public class ServicesServiceLocator extends org.apache.axis.client.Service implements webServices.ServicesService {
    ...
    private java.lang.String Services_address = "http://localhost:8080/WebServiceSOAP/services/Services";
    ...
    public webServices.Services getServices(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            webServices.ServicesSoapBindingStub _stub = new webServices.ServicesSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (webServices.Services.class.isAssignableFrom(serviceEndpointInterface)) {
                webServices.ServicesSoapBindingStub _stub = new webServices.ServicesSoapBindingStub(new java.net.URL(Services_address), this);
                _stub.setPortName(getServicesWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://webServices", "ServicesService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://webServices", "Services"));
        }
